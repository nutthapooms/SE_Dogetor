  ...
  data: {
    ...
    symplistall: [
      ...
      [ { name: 'ขนร่วง',
          ...
          pic1: 'Disease/fur_fall1.jpg',
          pic2: 'Disease/fur_fall2.jpg',
          check: false } ],
      // Type 2
      [ { name: 'เหงือกแดง',
          detail: 'เหงือกมีลักษณะแดงก่ำ คล้ายเลือดออก',
          pic1: 'Disease/red_gum1.jpg',
          pic2: 'Disease/red_gum2.jpg',
          check: false },
        { name: 'ตาขุ่นมัว',
          detail: 'ลูกตาจมไปในเบ้าตา เห็นเส้นเลือดสีแดงบริเวณตาขาว ด้านหน้าตวงตาขุ่น ม่านตาขยาย ไม่ตอบสนองต่อแสง',
          pic1: 'Disease/glaucoma1.jpg',
          pic2: 'Disease/glaucoma2.jpg',
          check: false },
        { name: 'มีไขมันคอไหล่',
          detail: 'พบก้อนไขมันตามคอและไหล่ ลักษณะเป็นลูกๆ',
          pic1: 'Disease/lump1.jpg',
          pic2: 'Disease/lump2.jpg',
          check: false },
        { name: 'ลิ้นห้อย',
          detail: 'อ้าปากตลอดเวลา ลิ้นห้อย',
          pic1: 'Disease/hang_tongue1.jpg',
          pic2: 'Disease/hang_tongue2.jpg',
          check: false },
        { name: 'มีน้ำมูก',
          detail: 'มีน้ำมูกไหล จมูกเปียกกว่าปกติ',
          pic1: 'Disease/snot1.jpg',
          pic2: 'Disease/snot2.jpg',
          check: false } ],
      // Type 3
      [ { name: 'ถ่ายเหลว',
          detail: 'อุจจาระเหลวคล้ายน้ำ ไม่เป็นก้อน',
          pic1: 'Disease/diarrhea1.jpg',
          pic2: 'Disease/diarrhea2.jpg',
          check: false },
        { name: 'ปัสสาวะน้อย',
          detail: 'ปัสสาวะน้อยกว่าที่ควรเป็น ปัสสาวะไม่ออก หรือไม่ค่อยปัสสาวะ',
          pic1: 'Disease/less_pee1.jpg',
          pic2: 'Disease/less_pee2.jpg',
          check: false },
        { name: 'ปัสสาวะมาก',
          detail: 'ปัสสาวะในปริมาณมาก หรือปัสสาวะบ่อยครั้ง',
          pic1: 'Disease/more_pee1.jpg',
          pic2: 'Disease/more_pee2.jpg',
          check: false },
        { name: 'อาเจียนอาหาร',
          detail: 'อาเจียนอาหารที่รับประทานเข้าไป หรือมีการขย่อนอาหารออกมา',
          pic1: 'Disease/vomit1.jpg',
          pic2: 'Disease/vomit2.jpg',
          check: false },
        { name: 'อาเจียนเลือด',
          detail: 'อาเจียนเลือดออกทางปาก',
          pic1: 'Disease/blood1.jpg',
          pic2: 'Disease/blood2.jpg',
          check: false },
        { name: 'เบื่ออาหาร',
          detail: 'รับประทานอาหารน้อยหรือไม่รับประทานเลย',
          pic1: 'Disease/bored_food1.jpg',
          pic2: 'Disease/bored_food2.jpg',
          check: false },
        { name: 'ผอมเกินควร',
          detail: 'กินมากขึ้น แต่ผอมกว่าที่ควรจะเป็น',
          pic1: 'Disease/thin1.jpg',
          pic2: 'Disease/thin2.jpg',
          check: false },
        { name: 'ท้องมาน',
          detail: 'ท้องบวมป่องเหมือนมีน้ำอยู่ภายในช่องท้อง',
          pic1: 'Disease/dropsy1.jpg',
          pic2: 'Disease/dropsy2.jpg',
          check: false },
        { name: 'กระหายน้ำผิดปกติ',
          detail: 'กินน้ำมากหรือกินบ่อย กินเก่ง',
          pic1: 'Disease/thirsty1.jpg',
          pic2: 'Disease/thirsty2.jpg',
          check: false } ],
      // Type 4
      [ { name: 'หอบ',
          detail: 'หายใจหอบผิดปกติ ดูหายใจติดขัด',
          pic1: 'Disease/gasp1.jpg',
          pic2: 'Disease/gasp2.jpg',
          check: false } ],
      // Type 5
      [ { name: 'ช็อค',
          ...
          pic1: 'Disease/shock1.jpg',
          pic2: 'Disease/shock2.jpg',
          check: false },
        { name: 'ชัก',
          detail: 'สูญเสียการควบคุมร่างกาย ไม่สามารถควบคุมการขับถ่าย มึนงง เดินไปอย่างไร้จุดมุ่งหมาย',
          pic1: 'Disease/twitch1.jpg',
          pic2: 'Disease/twitch2.jpg',
          check: false },
        { name: 'ซึม',
          detail: 'ไม่สดใสร่าเริง ดูไม่มีเรี่ยวแรง ไม่ค่อยตอบสนอง',
          pic1: 'Disease/depress1.jpg',
          pic2: 'Disease/depress2.jpg',
          check: false },
        { name: 'ไอ',
          detail: 'มีอาการไอคล้ายมนุษย์',
          pic1: 'Disease/cough1.jpg',
          pic2: 'Disease/cough2.jpg',
          check: false },
        { name: 'กล้ามเนื้อกระตุก',
          detail: 'กล้ามเนื้อกระตุก ไม่สามารถควบคุมได้',
          pic1: 'Disease/jerky1.jpg',
          pic2: 'Disease/jerky2.jpg',
          check: false },
        { name: 'กล้ามเนื้ออ่อนแรง',
          detail: 'ดูไม่มีเรี่ยวแรง เชื่องช้า ขยับไม่เป็นธรรมชาติ',
          pic1: 'Disease/weak1.jpg',
          pic2: 'Disease/weak2.jpg',
          check: false },
        { name: 'อยู่ไม่นิ่ง',
          detail: 'ลุก นั่ง หรือเดินไปมาบ่อยครั้ง',
          pic1: 'Disease/not_still1.jpg',
          pic2: 'Disease/not_still2.jpg',
          check: false },
        { name: 'เดินไม่ตรง',
          detail: 'เดินเบี้ยวหรือเซไปมา',
          pic1: 'Disease/walk1.jpg',
          pic2: 'Disease/walk2.jpg',
          check: false },
        { name: 'อุณภูมิสูง',
          detail: 'อุณหภูมิสูงกว่า 39 องศาเซลเซียส',
          pic1: 'Disease/high_tem1.jpg',
          pic2: 'Disease/high_tem2.jpg',
          check: false } ],
    ]
  },
  methods: {
